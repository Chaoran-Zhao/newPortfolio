...
const NavBar = () => {
  ...
  return (
    <Box
      ...
      style={{height:'80px',padding:window.innerWidth <500 ? 'none' : 'auto', width:'100%'}}
    >
      ...
      <Box sx={{ display: 'flex', flexWrap:'wrap' }} flex={4} 
      ...
      >
        ...
        <Button
          style={{ color: colors.primary[100], fontSize: window.innerWidth <500 ? "0.6rem" : "1rem", padding: window.innerWidth <500 ? '4px': '8px'  }}
